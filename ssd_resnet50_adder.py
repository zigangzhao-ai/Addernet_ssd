...
from resnet18_adder import Extra_layers, conv1x1, conv3x3, conv1_bn, conv1_bn_norelu
...
def multibox_adder(resnet, extra_layers, num_classes):
    ...
    ### may be have bug ###
    loc_layers += [conv1_bn_norelu(512, 4 * 4, stride=1)]
    conf_layers += [conv1_bn_norelu(512, 4 * num_classes, stride=1)]

    loc_layers += [conv1_bn_norelu(1024, 6 * 4, stride=1)]
    conf_layers += [conv1_bn_norelu(1024, 6 * num_classes, stride=1)]

    loc_layers += [conv1_bn_norelu(2048, 6 * 4, stride=1)]
    conf_layers += [conv1_bn_norelu(2048, 6 * num_classes, stride=1)]

    loc_layers += [conv1_bn_norelu(512, 6 * 4, stride=1)]
    conf_layers += [conv1_bn_norelu(512, 6 * num_classes, stride=1)]

    loc_layers += [conv1_bn_norelu(256, 4 * 4, stride=1)]
    conf_layers += [conv1_bn_norelu(256, 4 * num_classes, stride=1)]
...
def multibox_adder_1(resnet, extra_layers, num_classes):
    ...
    ### may be have bug ###
    loc_layers += [conv1x1(512, 4 * 4, stride=1)]
    conf_layers += [conv1x1(512, 4 * num_classes, stride=1)]

    loc_layers += [conv1x1(1024, 6 * 4, stride=1)]
    conf_layers += [conv1x1(1024, 6 * num_classes, stride=1)]

    loc_layers += [conv1x1(2048, 6 * 4, stride=1)]
    conf_layers += [conv1x1(2048, 6 * num_classes, stride=1)]
...
def build_ssd(phase, size=300, num_classes=21):
    ...
    extra = Extra_layers(2048)

    base_, extras_, head_ = multibox_adder(resnet.resnet50(), extra, num_classes)
