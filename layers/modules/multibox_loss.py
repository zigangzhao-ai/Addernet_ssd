...
class MultiBoxLoss(nn.Module):
    ...
    def forward(self, predictions, targets):
        ...
        #loss_l = F.l1_loss(loc_p, loc_t, size_average=False)  ##I don't understand
        ...
        loss_c[0] = 0  # filter out pos boxes for now
        ...
        if USE_FL:
            alpha = np.array([[0.25], [0.75], [0.75], [0.75]])
        ...
        loss_l /= N
        loss_c /= N
        #print(float(loss_l), float(loss_c))
