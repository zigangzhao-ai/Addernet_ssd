...
data_train_loader = DataLoader(data_train, args.batch_size, shuffle=True, num_workers=8)
...
def train(epoch):
    ...
    for i, (images, labels) in enumerate(data_train_loader):
        ...
        print('Training Epoch: [ {epoch} || [{trained_samples}/{total_samples}]\t || Loss: {:0.4f}\t || LR: {:0.6f} ]'.format(
            ...
            epoch=epoch,
            trained_samples=i * args.batch_size + len(images),
            total_samples=len(data_train_loader.dataset)
        ))
